...
public class FortradeRPage extends BasePage {
    ...
    @FindBy(xpath = /*"//div[contains(@class,'svglogo')]"*//*"//div[contains(@class,'logo')]"*/"/html/body/main/section[1]/div/header/div")
    ...
    public By alreadyHaveAnAccountLinkBy = By.xpath(/*"//div[@class='LoginLink']//a[contains(text(), 'Already have an account?')]"*/"//div[@class='alreadyHaveAcc']//a[contains(text(), 'Already have an account?')]");
