...
public class allBlueDlp extends BaseTestFortrade {
    ...
    public void setUp(String tag,String regulation) {
        ...
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age-annual-saving-knowledge" + tag);
    ...
    public void checkingTagsInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age-annual-saving-knowledge&tg=ivanA" +
    ...
    public void checkingAgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age" + tag);
    ...
    public void checkingAnnualParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=annual" + tag);
    ...
    public void checkingSavingParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=saving" + tag);
    ...
    public void checkingKnowledgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=knowledge" + tag);
    ...
    public void assertInvalidTokenMsg(String tag, String countryCode, String regulation) throws IOException, AWTException {
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=sms-age-annual-saving-knowledge" + tag);
    ...
    public void checkingLogoClickability(String regulation, String tag) throws IOException, AWTException {
        fortradePage.checkLogoClickability(regulation, "https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age-annual-saving-knowledge" + tag);
    ...
    public void loginRedirectionTest(String regulation) throws IOException, AWTException, InterruptedException {
        ...
        fortradePage.takeScreenshot("Login page - the user is successfully redirected - "+regulation+" regulation");
    }
    ...
    public void checkLanguageParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=plang:srcs,all" + tag);
    ...
    public void dummyLeadRegistration(String countryCode, String regulation, String tag) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=annual-saving-knowledge-age&" +
    ...
    public void invalidLeadRegistration(String countryCode, String regulation, String tag) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age-annual-saving-knowledge&ftsquery=age(1)-" +
                "or-[saving-equals(1,2,3)-and-knowledge-notequals(5)]" + tag);
        fortradePage.successfullyRegistration("Testq", "Testa", email, countryCode,
                TestData.phoneNumberGenerator(), "25-34", "$15,000-$50,000", "$50,000 – $100,000",
                "All the above");
        crmPage.checkCrmData(email, "Testq Testa", regulation);
    ...
    public void emptyLeadRegistration(String countryCode, String regulation, String tag) throws InterruptedException, IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrade.com/minilps/en/all-blue-dlp/?fts=age-annual-saving-knowledge&ftsquery=age-" +
                "equals(1,3)-or-[saving-equals(1,2,3)-and-knowledge-notequals(5)]"+tag);
        fortradePage.successfullyRegistration("Testq", "Testa", email, countryCode,
