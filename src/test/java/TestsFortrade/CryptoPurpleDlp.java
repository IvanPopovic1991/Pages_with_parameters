...
public class CryptoPurpleDlp extends BaseTestFortrade{
    ...
    public void setUp(String tag) {
        ...
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age-annual-saving-knowledge" + tag);
    ...
    public void demoAccountRegistration(String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        ...
        if(regulation.equals("iiroc")){
            fortradePage.closePersonalizeYourContent();
    ...
    public void checkingTagsInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        ...
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age-annual-saving-knowledge&tg=ivanA" +
    ...
    public void checkingDummyFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age-annual-saving-knowledge-plang:all&" +
    ...
    public void checkingInvalidFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age-annual-saving-knowledge&" +
                "ftsquery=age-equals(1,2)-and-[[annual-notequals(2,3)-or-saving-equals(3)]-and-[knowledge-equals(1,2)-or-plang-notequals(1)]]&" +
                "tg=ivanA1434&tag1=ivanB@1434&tag2=ivanL1434&tag3=ivanM1434&gid=ivanC@1434&G_GEO=ivanD1434&G_GEOint=ivanE1434&G_" +
                "Device=ivanF1434&G_DeviceModel=ivanG1434&G_AdPos=ivanH1434&g_Track=ivanI1434&Track=ivanj1434&gclid=ivanK1434" + tag);
        String url = driver.getCurrentUrl();
    ...
    public void checkingAgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age" + tag);
    ...
    public void checkingAnnualParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=annual" + tag);
    ...
    public void checkingSavingParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=saving" + tag);
    ...
    public void checkingKnowledgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=knowledge" + tag);
    ...
    public void assertInvalidTokenMsg(String tag, String countryCode, String regulation) throws IOException, AWTException {
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=sms-age-annual-saving-knowledge"+tag);
        ...
        fortradePage.takeScreenshot("Incorrect code - Please check and try again - "+regulation,fortradePage.incorrectTokenMsg);
    }
    ...
    public void checkingLogoClickability(String regulation, String tag) throws IOException, AWTException {
        fortradePage.checkLogoClickability(regulation, "https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=age-annual-saving-knowledge" + tag);
    ...
    public void errorMessagesAllParameters(String countryCode ,String regulation) throws IOException, AWTException, InterruptedException {
        fortradePage.unsuccessfullyRegistration("Testq", "Testa", TestData.emailGenerator(), countryCode, TestData.phoneNumberGenerator(),
                "25-34", "$15,000-$50,000", "$50,000 – $100,000", "All the above",
    ...
    public void checkLanguageParameter(String tag, String countryCode ,String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?fts=plang:srcs,all"+tag);
    ...
    @Test
    @Parameters({"regulation"})
    public void checkFCAPercentages(String regulation) throws IOException, AWTException {
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?tg=skip&G_GEO=1006453&regulation=FCA");
    ...
    @Test
    @Parameters({"regulation"})
    public void checkCysecPercentages(String regulation) throws IOException, AWTException {
        fortradePage.newUrl("https://www.fortrade.com/minilps/en/crypto-purple-dlp/?tg=skip&G_GEO=1000997&regulation=CYSEC");
