...
public class NvidiaDlp extends BaseTestFortradeR {
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException, InterruptedException {
        ...
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingCustomTag() throws InterruptedException, IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all");
        fortradeRPage.successfullyRegistration("Testq", "Testa", email, "Serbia",
    ...
    public void checkingNonValidParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=testq-testa");
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=knowledge");
    ...
    public void assertInvalidTokenMsg() throws IOException, AWTException {
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=sms-age-annual-saving-knowledge");
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        fortradeRPage.checkLogoClickability("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge");
...
/*    @Test(description = "Verify the click on Contact us link opens new mail window")
    ...
    public void checkLanguageParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=plang:srcs,all");
    ...
    public void dummyLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=annual-saving-knowledge-age-plang:all&" +
    ...
    public void invalidLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all&ftsquery=age(1)-" +
    ...
    public void emptyLeadRegistration() throws InterruptedException, IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all&ftsquery=age-" +
    ...
    public void verifyLanguageField() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all&userLang=en");
    ...
    public void verifyLanguage() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.fortrader.com/lps/nvidia/en?fts=age-annual-saving-knowledge-plang:all&userLang=he");
        fortradeRPage.successfullyRegistration("Testq","Testa",email,"Serbia",TestData.phoneNumberGenerator(),
                "25-34", "$15,000-$50,000", "$50,000-$100,000", "All the above","English");
        fortradeRPage.assertURL("https://ready.fortrade.com/");
        crmPage.checkCrmData(email,"Testq Testa","FSC");
