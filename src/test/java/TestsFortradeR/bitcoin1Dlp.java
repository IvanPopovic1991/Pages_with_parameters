...
public class bitcoin1Dlp extends BaseTestFortradeR {
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        ...
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=knowledge");
    ...
    public void alreadyRegisteredAccountTest() throws IOException, AWTException {
        ...
        fortradeRPage.successfullyRegistration("Testq", "Testa", email,
                "381", TestData.phoneNumberGenerator(), "25-34", "$15,000-$50,000",
                "$50,000 – $100,000", "All the above","English");
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age-annual-saving-knowledge-plang:all");
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        fortradeRPage.checkLogoClickability("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age-annual-saving-knowledge");
...
/*    @Test
    ...
    public void checkLanguageParameter() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=plang:srcs,all");
    ...
    public void invalidLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age-annual-saving-knowledge-plang:all&ftsquery=age(1)-or-[saving-equals(1,2,3)-and-knowledge-notequals(5)]");
        fortradeRPage.successfullyRegistration("Testq", "Testa", email, "381",
    ...
    public void emptyLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/bitcoin1-dlp/?fts=age-annual-saving-knowledge-plang:all&ftsquery=age-equals(1,3)-or-[saving-equals(1,2,3)-and-knowledge-notequals(5)]");
        fortradeRPage.successfullyRegistration("Testq", "Testa", email,"381",
                TestData.phoneNumberGenerator(), "45-54", "$15,000-$50,000", "$100,000 – $250,000",
                "All the above","English");
        crmPage.checkCrmData(email, "Testq Testa","FortradeR");
