...
public class newDayTradingWoman extends BaseTestFortradeR {
    @BeforeMethod
    public void setUp() {
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        ...
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=age-annual-saving-knowledge&tg=ivanA" +
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=age");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=annual");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=saving");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=knowledge");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void assertInvalidTokenMsg() throws IOException, AWTException {
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=sms-age-annual-saving-knowledge");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void alreadyRegisteredAccountTest() throws IOException, AWTException {
        ...
        fortradeRPage.successfullyRegistration("Testq", "Testa", email,
                "381", TestData.phoneNumberGenerator(), "25-34", "$15,000-$50,000",
                "$50,000 – $100,000", "All the above");
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=age-annual-saving-knowledge");
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
        fortradeRPage.checkLogoClickability("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=age-annual-saving-knowledge");
    ...
    public void checkLanguageParameter() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/day-trading-woman-2025/?fts=plang:srcs,all");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
