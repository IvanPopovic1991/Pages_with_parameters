...
public class WorldMapGraphDlp extends BaseTestFortradeR {
    @BeforeMethod
    public void setUp() {
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=age");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=annual");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=saving");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=knowledge");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void assertInvalidTokenMsg() throws IOException, AWTException {
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=sms-age-annual-saving-knowledge");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
        fortradeRPage.checkLogoClickability("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=age-annual-saving-knowledge");
    ...
    public void checkLanguageParameter() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/worldmap-graph-dlp/?fts=plang:srcs,all");
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
