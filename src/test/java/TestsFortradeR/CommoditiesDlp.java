...
public class CommoditiesDlp extends BaseTestFortradeR {
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        ...
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=knowledge");
    ...
    public void assertInvalidTokenMsg() throws IOException, AWTException {
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=sms-age-annual-saving-knowledge");
    ...
    public void alreadyRegisteredAccountTest() throws IOException, AWTException {
        ...
        fortradeRPage.successfullyRegistration("Testq", "Testa", email,
                "381", TestData.phoneNumberGenerator(), "25-34", "$15,000-$50,000",
                "$50,000 – $100,000", "All the above","English");
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=age-annual-saving-knowledge-plang:all");
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        fortradeRPage.checkLogoClickability("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=age-annual-saving-knowledge");
...
/*    @Test
    ...
    public void checkLanguageParameter() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://www.fortrader.com/minilps/en/en-commodities-dlp/?fts=plang:srcs,all");
