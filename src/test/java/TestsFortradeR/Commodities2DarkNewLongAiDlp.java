...
public class Commodities2DarkNewLongAiDlp extends BaseTestFortradeR {
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        ...
        driver.get("https://www.fortrader.com/minilps/en/commodities2-dark-new-long-ai-dlp/?fts=age-annual-saving-knowledge&tg=ivanA" +
    ...
    public void alreadyRegisteredAccountTest() throws IOException, AWTException {
        ...
        fortradeRPage.successfullyRegistration("Testq", "Testa", email,
                "381", TestData.phoneNumberGenerator(), "25-34", "$15,000-$50,000",
                "$50,000 – $100,000", "All the above");
        driver.get("https://www.fortrader.com/minilps/en/commodities2-dark-new-long-ai-dlp/?fts=age-annual-saving-knowledge");
