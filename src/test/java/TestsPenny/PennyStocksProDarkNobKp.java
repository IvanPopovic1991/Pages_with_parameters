...
public class PennyStocksProDarkNobKp extends BaseTestPenny{
    ...
    public void demoAccountRegistration() throws IOException, AWTException, InterruptedException {
        ...
        pennyStocks.assertURL(TestData.kapitalRSUrl);
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException, InterruptedException {
        ...
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingNonValidParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=testq-testa");
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=knowledge");
    ...
    public void checkLanguageParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=plang:srcs,all");
    ...
    public void assertInvalidTokenMsg() throws IOException, AWTException, InterruptedException {
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    public void didNotGetToken() throws IOException, AWTException, InterruptedException {
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=sms-age-annual-saving-knowledge");
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        pennyStocks.checkLogoClickability("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge");
    ...
    public void dummyLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=annual-saving-knowledge-age-plang:all&" +
    ...
    public void invalidLeadRegistration() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge-plang:all&ftsquery=age(1)-" +
    ...
    public void emptyLeadRegistration() throws InterruptedException, IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge-plang:all&ftsquery=age-" +
    ...
    public void checkBoxErrorMessage () throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en");
    ...
    public void verifyLanguageField() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge-plang:all&userLang=en");
    ...
    public void verifyLanguage() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark-nob-kp/en?fts=age-annual-saving-knowledge-plang:all&userLang=he");
        pennyStocks.successfullyRegistration("Testq","Testa",email, "Serbia",TestData.phoneNumberGenerator(),
                "25-34", "$15,000-$50,000", "$50,000-$100,000", "All the above", "English");
        pennyStocks.assertURL(TestData.kapitalRSUrl);
        crmPage.checkCrmData(email,"Testq Testa", "FSC");
