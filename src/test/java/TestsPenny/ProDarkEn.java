...
public class ProDarkEn extends BaseTestPenny{
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException, InterruptedException {
        ...
        driver.get("https://dlp.pennystocks-uk.com/lps/pro-dark/en?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        pennyStocks.checkLogoClickability("https://dlp.pennystocks-uk.com/lps/pro-dark/en?fts=age-annual-saving-knowledge");
