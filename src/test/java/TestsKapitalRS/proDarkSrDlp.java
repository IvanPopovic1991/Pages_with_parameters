...
public class proDarkSrDlp extends BaseTestKapitalRS{
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        ...
        driver.get("https://dlp.kapitalrs.com/lps/pro-dark/sr?fts=age-annual-saving-knowledge&tg=ivanA" +
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        kapitalRsPage = new KapitalRsPage(driver);
        kapitalRsPage.checkLogoClickability("https://dlp.kapitalrs.com/lps/pro-dark/sr?fts=age-annual-saving-knowledge");
